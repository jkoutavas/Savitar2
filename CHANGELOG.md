...
- **Minimum macOS is 12.0** — Xcode 27 no longer accepts a 11.0 deployment target (supported range is 12.0–27.x)
...
- **View → Wrap Lines** — live wrap for the session (and text documents); world default on **World Settings → Output**; title-bar wrap button

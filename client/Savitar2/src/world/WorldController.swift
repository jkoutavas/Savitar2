...
class WorldController: NSController {
    ...
    @objc dynamic var echoBackColor: NSColor { get { world.echoBackColor } set(echoBackColor) { world.echoBackColor = echoBackColor } }
    @objc dynamic var intenseColor: NSColor { get { world.intenseColor } set(intenseColor) { world.intenseColor = intenseColor } }
    ...
    @objc dynamic var monoFontName: String { get { world.monoFontName } set(monoFontName) { world.monoFontName = monoFontName } }

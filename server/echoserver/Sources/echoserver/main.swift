...
//                    print("Socket Signature: \(String(describing: newSocket.signature?.description))")
    ...
    func addNewConnection(socket: Socket) {
        ...
        let esc = "\u{1B}"
        let ansiTestStr = "^[1mANSI Intense^[0m, ^[5mANSI Blink^[25m, ^[7mANSI Reverse^[27m, ^[3;4mANSI Italic and ANSI Underline^[0m. Also, ^[38;2;20;50;100mANSI 24-bit color^[0m".replacingOccurrences(of: "^[", with: "\(esc)[")
